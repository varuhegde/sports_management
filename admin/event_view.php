...
<?php include('sidebar.php');?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="event_edit.php?event_id=<?php echo $row['event_id'];?>" class="btn btn-primary">Edit</a></td>
      <td><a href="event_delete.php?event_id=<?php echo $row['event_id'];?>" class="btn btn-danger">Delete</a></td>
    </tr>
	<?php
	}
	?>
