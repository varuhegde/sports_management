...
<?php include('sidebar.php');?>
      ...
      <div class="row">
        <div class="col-md-14">
          <div class="tile">
            ...
            <div class="tile-body">
			<form action="student_next.php" method="post" name="form1" class="form-control">
			<b>Select Branch : </b>
	...
	{
	?>
	<option value="<?php echo $row['branch_id'];?>" <?php if($row['branch_id']==$branch_id) {?> selected <?php } ?>><?php echo $row['branch_name'];?></option>
	<?php
	}
	?>
	<input type="submit" value="Search" name="s1" class="btn btn-primary">
  ...
  <tbody>
	<?php
	include('../db_connect/db_connect.php');
	$sql="select * from student sd,branch br where sd.branch_id=br.branch_id and sd.branch_id='$branch_id'";
	$res=mysqli_query($conn,$sql);
	$no=1;
	while($row=mysqli_fetch_array($res))
	{
