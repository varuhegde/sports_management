...
<?php include('sidebar.php');?>
    ...
    <a href="student_form.php" class="btn btn-primary">ADD NEW</a>
    <hr>
      <div class="row">
        <div class="col-md-14">
          <div class="tile">
  ...
  <tbody>
	...
	$sql="select * from student sd,branch br where sd.branch_id=br.branch_id";
    ...
    <tr>
      ...
      <td>&nbsp;<img src="../images/<?php echo $row['student_photo'];?>" width="200" height="200"></td>
      <td><a href="student_edit.php?student_id=<?php echo $row['student_id'];?>">edit</a></td>
      <td><a href="student_delete.php?student_id=<?php echo $row['student_id'];?>">delete</a></td>
    </tr>
	<?php
	}
	?>
