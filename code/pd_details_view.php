...
<?php include('sidebar.php');?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>&nbsp;<img src="../images/<?php echo $row['pd_photo'];?>" width="200" height="200"></td>
      <td><a href="pd_details_edit.php?pd_id=<?php echo $row['pd_id'];?>">edit</a></td>
      <td><a href="pd_details_delete.php?pd_id=<?php echo $row['pd_id'];?>">delete</a></td>
    </tr>
	<?php
	}
	?>
