		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="forcheck.php" method="post" class="signin-form">
		      		<div class="form-group">
		      			<input name="username" type="text" class="form-control" placeholder="Username" required>
		      		</div>
	            <div class="form-group">
	              <input name="email_id" id="password-field" type="password" class="form-control" placeholder="Email Id" required>
	              <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
	            </div>
	            
	            <div class="form-group">
	            	<button type="submit" class="btn form-control submit px-8 "  >Submit</button>
	            </div>
